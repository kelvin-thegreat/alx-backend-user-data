...
+ [x] 0. Et moi et moi et moi!
    ...
    + Copy all your work of the [0x06. Basic authentication](https://github.com/kelvin-thegreat/alx-backend-user-data/tree/master/0x01-Basic_authentication) project in this new folder.
    ...
    + Now, you will add a new endpoint: `GET /users/me` to retrieve the authenticated `User` object.
        + Copy folders `models` and `api` from the previous project [0x06. Basic authentication](https://github.com/kelvin-thegreat/alx-backend-user-data/tree/master/0x01-Basic_authentication).
...
+ In the file [api/v1/views/init.py](api/v1/views/init.py), you must add this new view at the end of the file.
